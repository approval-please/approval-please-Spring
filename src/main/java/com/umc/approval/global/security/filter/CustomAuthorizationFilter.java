    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        return !(
                ...
                pathMatcher.match("/auth/logout", path)
                        ...
                        || pathMatcher.match("/documents/likes/**", path) && request.getMethod().equals("GET")
                        ...
                        || pathMatcher.match("/community/toktoks/votes/**", path) && request.getMethod().equals("GET")
                        || pathMatcher.match("/community/reports/documents", path) && request.getMethod().equals("GET")
                        ...
                        || (pathMatcher.match("/notification/**", path) && request.getMethod().equals("POST"))
        );
    }
